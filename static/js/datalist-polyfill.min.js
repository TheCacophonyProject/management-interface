...
!(function () {
  ...
  var e = window.document,
    ...
    n = Boolean(t.match(/Trident\/[6-7]\./)),
    a = Boolean(-1 !== t.indexOf("Edge/"));
  if (i && !n && !a) return !1;
  Element.prototype.matches ||
    (Element.prototype.matches = Element.prototype.msMatchesSelector);
  var r = !1,
    o = ["text", "email", "number", "search", "tel", "url"];
  window.addEventListener("touchstart", function e() {
    (r = !0), window.removeEventListener("touchstart", e);
  });
  var l,
  ...
  var u = function (e) {
      ...
      if (e.target.matches("input[list]")) {
        ...
        if ("input" === t.tagName.toLowerCase() && null !== i) {
          if (
            ...
            var r = t.list.options[0];
            r.value = r.value;
          }
          if (!n && !a) {
            var o = i.getElementsByClassName("polyfilling")[0] || h(t, i),
              l =
                o &&
                o.querySelector("option:not(:disabled)") &&
                (("focusin" === e.type && "" !== f(t)) ||
                  (e.relatedTarget && e.relatedTarget === o));
            A(l, o);
          }
        }
      }
    ...
    f = function (e) {
      return "email" === e.getAttribute("type") &&
        ...
        ? e.value.substring(e.value.lastIndexOf(",") + 1)
        : e.value;
    },
    g = function (e, t) {
      var i;
    ...
    var m,
        ...
        Array.prototype.slice
          ...
          .forEach(function (e) {
            var t = e.value,
              ...
              n = e.text;
            if (c(e, a)) {
              var r = n.substr(0, t.length + " / ".length);
              n && !i && n !== t && r !== t + " / "
                ? (e.innerText = t + " / " + n)
      ...
      h = function (t, i) {
        if (
          !(
            (t.getAttribute("type") &&
              -1 === o.indexOf(t.getAttribute("type"))) ||
            null === i
          )
        ) {
          ...
          if (
            ...
            r || l.setAttribute("aria-multiselectable", "false"),
      ...
      E = function (t) {
        ...
        "select" === i.tagName.toLowerCase() &&
          ...
          (!t.key ||
            ...
            (a.focus(),
            "Backspace" === t.key
              ? ((a.value = a.value.substr(0, a.value.length - 1)), C(a))
              : (a.value += t.key),
            b(n, a)));
      },
      w = function (t) {
        ...
        if ("select" === i.tagName.toLowerCase() && null !== a) {
          var r = t.type,
            o = "keydown" === r && 13 !== t.keyCode && 27 !== t.keyCode;
          ("change" === r ||
            "click" === r ||
            ("keydown" === r && (13 === t.keyCode || "Tab" === t.key))) &&
          i.value.length > 0 &&
          i.value !== n.title
            ? (g(a, i.value),
              C(a),
              ...
              (o = !1))
            : "keydown" === r && 27 === t.keyCode && a.focus(),
            A(o, i);
        }
      },
      C = function (t) {
