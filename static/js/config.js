...
function loadConfig() {
  ...
  xmlHttp.onload = async function() {
    if (xmlHttp.status == 200) {
      ...
      $("#input-start-recording").attr('placeholder', response.defaults.windows.StartRecording)
      $("#input-stop-recording").attr('placeholder', response.defaults.windows.StopRecording)
      $("#input-power-on").attr('placeholder', response.defaults.windows.PowerOn)
      $("#input-power-off").attr('placeholder', response.defaults.windows.PowerOff)
